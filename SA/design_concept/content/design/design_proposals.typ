...
= Design Proposals
In the following, all considered designs for function and type composition as well as the overall tool design are documented.

== Overall tool design
VisualFP should work in an IDE-style.
...
- The defined content is loaded into an interactive GHCi session where the user can interact with it.
