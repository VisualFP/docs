...
Both text and a visual editor can create programs.
...
Based on that, Enso seems to be an excellent tool for working on datasets but not so much for creating programs with actual logic.