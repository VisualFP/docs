...
The central part of this project is to document the design process
used to create VisualFP transparently. This allows others to better understand 
decisions made during the project, which alternatives were considered, and
to evaluate whether they want to follow the same path.
