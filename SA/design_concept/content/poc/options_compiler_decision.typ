...
requirements, to call such an implementation a compiler platform could be considered an exaggeration, which is why it'll be called an inference engine from now on.
