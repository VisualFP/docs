...
GHC is the only still actively developed compiler-platform out of the considered platforms.
Since VisualFP will rely heavily on the chosen platform, a
platform change later down the road would be difficult.

After testing and research, the GHC #ac("API") is considered to be too complicated,
