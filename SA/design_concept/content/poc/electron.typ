...
- A desktop-app allows access to the local file-system, which would allow VisualFP to manage project files on the disk and use other development tools, such as cabal (TODO: insert reference here).
