...
The Threepenny UI starts a local web-server where it serves static files for the UI.
...
As can be seen in @component-diagram, the translation component translates between the data models used by the UI and the type inference:
